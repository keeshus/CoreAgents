...
- Name: 75-groups.spec.ts >> Groups feature >> SSO config page loads and shows fields
- Location: test/e2e/75-groups.spec.ts:413:3
    ...
    - generic [ref=e4]:
      - generic [ref=e5]:
        - link "arrow_back Back" [ref=e6] [cursor=pointer]:
          ...
          - generic [ref=e8]: Back
        - generic [ref=e9]:
          - heading "SSO / OIDC Configuration" [level=1] [ref=e10]
          - paragraph [ref=e11]: Configure single sign-on with your identity provider
      - generic [ref=e12]:
        - generic [ref=e13] [cursor=pointer]:
          - checkbox "Enable SSO" [checked] [ref=e14]
          - generic [ref=e15]: Enable SSO
        - generic [ref=e16]:
          - generic [ref=e17]:
            - textbox "Provider name" [ref=e19]:
              - /placeholder: " "
              - text: test-provider-1785587313629
            - generic: Provider name
            - paragraph [ref=e20]: e.g. keycloak, azure, google
          - generic [ref=e21]:
            - textbox "Client ID" [ref=e23]:
              - /placeholder: " "
              - text: test-client-id
            - generic: Client ID
          - generic [ref=e24]:
            - textbox "Client Secret" [ref=e26]:
              - /placeholder: " "
            - generic: Client Secret
            - paragraph [ref=e27]: Leave as-is to keep current value
          - generic [ref=e28]:
            - textbox "Issuer URL" [ref=e30]:
              - /placeholder: " "
              - text: https://sso.example.com
            - generic: Issuer URL
            - paragraph [ref=e31]: OIDC discovery URL
          - generic [ref=e32]:
            - textbox "Redirect URI" [ref=e34]:
              - /placeholder: " "
              - text: http://localhost:3001/api/auth/sso/callback
            - generic: Redirect URI
          - generic [ref=e35]:
            - textbox "Group claim name" [ref=e37]:
              - /placeholder: " "
              - text: roles
            - generic: Group claim name
            - paragraph [ref=e38]: "JWT claim containing group list (default: groups)"
        - generic [ref=e39]:
          - generic [ref=e40]:
            - textbox "Admin group mapping" [ref=e42]:
              - /placeholder: " "
            - generic: Admin group mapping
            - paragraph [ref=e43]: Comma-separated group names that map to admin role
          - generic [ref=e44]:
            - textbox "Editor group mapping" [ref=e46]:
              - /placeholder: " "
            - generic: Editor group mapping
            - paragraph [ref=e47]: Comma-separated group names that map to editor role
        - button "Save Configuration" [ref=e50] [cursor=pointer]
    - button "chat" [ref=e51] [cursor=pointer]:
      - generic [ref=e52]: chat
    - button "dark_mode" [ref=e53] [cursor=pointer]:
