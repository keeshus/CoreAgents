...
- Name: 75-groups.spec.ts >> Groups feature >> delete a group via UI
- Location: test/e2e/75-groups.spec.ts:90:3
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - button "chat" [ref=e313] [cursor=pointer]:
      - generic [ref=e314]: chat
    - button "dark_mode" [ref=e315] [cursor=pointer]:
      - generic [ref=e316]: dark_mode
