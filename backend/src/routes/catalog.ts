...
export const catalog: NodeCatalogEntry[] = [
  {
    ...
    defaultConfig: { endpointId: '', model: '', systemPrompt: '', responseFormat: 'text', outputSchema: '' },
    inputs: 1,
    outputs: 1,
  },
  {
  ...
  },
  {
    ...
    defaultConfig: { endpointId: '', model: '', prompt: '', temperature: 0.7, maxTokens: 1024, responseFormat: 'text' },
    inputs: 1,
    outputs: 1,
  },
  {
