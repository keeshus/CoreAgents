...
- Name: 75-groups.spec.ts >> Groups feature >> reader cannot create groups but can access pending executions
- Location: test/e2e/75-groups.spec.ts:422:3
  ...
  - generic [ref=e2]:
    - generic [ref=e4]:
      - generic [ref=e5]:
        ...
        - generic [ref=e9]:
          - generic [ref=e10]: Reader Perm Test
