...
- Name: 75-groups.spec.ts >> Groups feature >> non-admin user sees only unassigned and own group flows
- Location: test/e2e/75-groups.spec.ts:643:3
  ...
  - generic [ref=e2]:
    - generic [ref=e4]:
      - generic [ref=e5]:
        ...
        - generic [ref=e9]:
          - generic [ref=e10]: Visibility Reader
