...
export function BranchNode(props: NodeProps) {
  ...
  return (
    <BaseNode label={(props.data?.label as string) || 'Branch'} nodeType="Condition" category="processing" selected={props.selected || false} inputs={1} outputs={outputLabels.length} outputLabels={outputLabels}>
