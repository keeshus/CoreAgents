...
- Name: 76-sso.spec.ts >> SSO with mock OIDC >> SSO login as reader (unmapped group) gets reader role
- Location: test/e2e/76-sso.spec.ts:92:3
...
Expected pattern: /\/approvals/
Received string:  "http://localhost:3000/login?error=sso_not_configured"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    14 × unexpected value "http://localhost:3000/login?error=sso_not_configured"
